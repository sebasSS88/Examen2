...
public class AccountFacadeREST extends AbstractFacade<Account> {
    ...
    public List<Account> deleteAccountByDescription(@PathParam("description") String description) throws ReadException{
        List <Account> accounts = null;
        try{
            em.createNamedQuery("deleteAccountByDescription").setParameter("description", description).executeUpdate();
            em.flush();
            accounts = findAll();
        } catch(Exception e){
